...
export type FilterType = AffairType[] | AffairPriorityType
...
export const filterAffairs = (affairs: AffairType[], filterName: FilterType): AffairType[] => { // need to fix any
 if(filterName === 'all') {
     return affairs
 }
    return affairs.filter(el => el.priority === filterName)
